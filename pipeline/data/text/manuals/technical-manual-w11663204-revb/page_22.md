...
See page 2-4 to access Fault Code Display Mode.
...
| **PO W ER**                                       | **SOAK/WASH**| **RINSE**    | **FINAL SPIN** | **DONE**      |
| **F0E0 – NO FAULT**                               | ON           | 8            | 4            | 2            | OFF          | 8            | 4            | 2            | 1            |
...
| The START key has been actuated for 10 consecutive minutes. |
| Fault occurs during Diagnostic Test Mode if a stuck key is detected. |
| **See TEST #4: Console and Indicators.**          |
| **F2E3 – MISMATCH OF MAIN CONTROL AND UI**        | F            | 2            | E            | 2            | 1            |
...
2-8 **Maytag® 3.5 cu ft Commercial-Grade Residential Agitator Washer**
```