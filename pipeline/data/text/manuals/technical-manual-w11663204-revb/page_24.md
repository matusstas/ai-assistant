...
| Fault/Error Code – Description | Fault Number | Error Number | Status LEDs | Status LEDs |
|--------------------------------|--------------|--------------|-------------|-------------|
| **Explanation and Recommended Procedure** |              |              | **PO WER**   | **SOAK/WASH**  | **RINSE** | **FINAL SPIN** | **DONE** |
| **F727 – MOTOR UNABLE TO REACH TARGET RPM** | F | 4 | 2 | E | 4 | 2 | 1 |
...
| - Load of balance. Clothing should be distributed evenly when loading.  |
| - See TEST #3b: Drive System – Motor.  |

| **F801 – LONG FILL** | F | 8 | E | 1 |
...
| - Low water pressure; fill times longer than 6 minutes. Are hose screens plugged?  |
...
| **F803 – OVERFLOW CONDITION** | F | 8 | E | 2 | 1 |
...
| **F805 – HOT, COLD REVERSED** | F | 8 | E | 4 | 1 |
...
| - See TEST #2: Valves and TEST #5: Temperature Thermistor. |

| **F806 – NO FILL** | F | 8 | E | 4 | 2 |
| Fault is displayed when the water level does not change for a period of time OR water is present but main control does not detect the water level changing. |
| - Is water supply connected and turned on?  |
| - Low water pressure; fill times longer than 6 minutes. Are hose screens plugged?  |
| - Check for proper drain hose installation. Is water siphoning out of the drain hose?  |
